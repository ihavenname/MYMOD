...
public class ModIronCutAnvilHandler {

    private static final int REPAIR_PER_NUGGET = 17;
    ...
    public static void onAnvilUpdate(AnvilUpdateEvent event) {
        ...
        // 只修这个物品
        if (left.getItem() != ModItems.MOD_IRON_CUT.get()) return;

        // 使用原版铁粒
        if (right.isEmpty() || right.getItem() != Items.IRON_NUGGET) return;
